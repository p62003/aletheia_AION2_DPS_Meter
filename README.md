...
- **戰報分析** — 查看傷害佔比及同職業歷史平均對比，支援傷害/治癒模式切換
- 召喚物傷害自動合併至主人名下
...
| 戰報分析（傷害/治癒切換） | 風格自訂 | 網路診斷 |
|:---:|:---:|:---:|
| ![戰報分析](images/analyze_tool_zh2.png) | ![風格自訂](images/custom_tool_zh.png) | ![網路診斷](images/network_tool.png) |

- **Aletheia Analyzer** — 戰報分析工具，傷害/治癒模式切換，查看個人表現與歷史平均對比
- **Aletheia SkillMAP** — 全隊技能時間軸，以 2D MAP 呈現全隊技能施放記錄
- **Aletheia Customizer** — 獨立設定工具（浮窗設定/主題管理/熱鍵錄製/浮窗背景開關）
- **Aletheia 網路診斷** — 連線環境自檢，排查封包擷取問題（支援中英雙語）
...
A: v7.31 已自動相容大部分加速器，支援候選連線自動切換。若仍有問題，請使用隨附的「Aletheia 網路診斷工具」進行自檢。
...
A: v7.31 加入連續技分組、DOT 分類及技能合併，傷害數據更加精確。神石傷害、召喚物傷害均已計入總量。
