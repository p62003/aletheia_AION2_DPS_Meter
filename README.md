...
![主視窗 — 副本排名 + 技能明細 + 時間軸](images/mainwindow1.png)
...
![浮窗特寫](images/overlayer_ttf1.png)
...
![主視窗 — 戰鬥細節](images/mainwindow.png)
...
| | |
|:---:|:---:|
| ![浮窗疊加 — 場景1](images/overlayer_background1.png) | ![浮窗疊加 — 場景2](images/overlayer_background2.png) |
...
**Q: 延遲有數值但完全沒有傷害數據？**
A: v7.27 已自動相容大部分加速器。若仍有問題，請使用隨附的「Aletheia 網路診斷工具」進行自檢。詳見 TROUBLESHOOTING 指南。
